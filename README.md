...
* [AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,474 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator based on Unreal Engine for autonomous vehicles.
...
* [Ardupilot](https://github.com/ArduPilot/ardupilot) ⭐ 15,857 | 🐛 3,198 | 🌐 C++ | 📅 2026-09-12
* [PX4 Autopilot](https://github.com/PX4/PX4-Autopilot) ⭐ 12,607 | 🐛 367 | 🌐 C++ | 📅 2026-09-13 - Rebranded to AutoPilot from Firmware
* [Betaflight](https://github.com/betaflight/betaflight) ⭐ 11,529 | 🐛 358 | 🌐 C | 📅 2026-09-12 - Fork of Cleanflight.
* [INAV](https://github.com/iNavFlight/inav) ⭐ 4,216 | 🐛 472 | 🌐 C | 📅 2026-09-13
...
* [Open Source Rover Control Code](https://github.com/nasa-jpl/osr-rover-code) ⭐ 535 | 🐛 18 | 🌐 Python | 📅 2026-08-13 - Nasa JPL command firmware for the OSR.
* [BaseFlight](https://github.com/multiwii/baseflight) ⭐ 527 | 🐛 23 | 🌐 C | 📅 2016-01-18 - :ghost:
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 504 | 🐛 41 | 🌐 C | 📅 2026-09-13 - FC Firmware focusing on flight performance, innovative filtering, leading-edge feature additions, and wide target support.
* [madflight](https://github.com/qqqlab/madflight) ⭐ 493 | 🐛 2 | 🌐 C | 📅 2026-09-03 - Flight controller for Arduino ESP32 / RP2350 / RP2040 / STM32.
...
* [MAVROS](https://github.com/mavlink/mavros) ⭐ 1,221 | 🐛 400 | 🌐 C++ | 📅 2026-09-11 - MAVLink to ROS gateway with a proxy for Ground Control Station.
...
* [SmartTune CLI](https://github.com/raylanlin/smarttune-cli) ⭐ 28 | 🐛 0 | 🌐 Python | 📅 2026-09-13 - Multi-platform flight log analysis & tuning advisor for ArduPilot, Betaflight and PX4. Offline-first, designed for AI agents.

### Ground Control Stations

* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,929 | 🐛 1,031 | 🌐 C++ | 📅 2026-09-13 - Cross-platform ground control station for drones (Android, iOS, Mac OS, Linux, Windows).
...
* [JPL Open Source Rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,642 | 🐛 14 | 🌐 HTML | 📅 2026-09-03 - Nasa JPL scaled down version of the curiosity rover, made of COTS.
