...
* [ArduPilot Mission Planner](https://github.com/ArduPilot/MissionPlanner) ⭐ 2,346 | 🐛 1,360 | 🌐 C# | 📅 2026-07-11 - Mission planner software.
...
* [AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,400 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 - Open source simulator based on Unreal Engine for autonomous vehicles.
...
* [Ardupilot](https://github.com/ArduPilot/ardupilot) ⭐ 15,688 | 🐛 3,136 | 🌐 C++ | 📅 2026-08-14
* [PX4 Autopilot](https://github.com/PX4/PX4-Autopilot) ⭐ 12,421 | 🐛 341 | 🌐 C++ | 📅 2026-08-14 - Rebranded to AutoPilot from Firmware
* [Betaflight](https://github.com/betaflight/betaflight) ⭐ 11,409 | 🐛 350 | 🌐 C | 📅 2026-08-14 - Fork of Cleanflight.
* [INAV](https://github.com/iNavFlight/inav) ⭐ 4,183 | 🐛 434 | 🌐 C | 📅 2026-08-05
...
* [EmuFlight](https://github.com/emuflight/EmuFlight) ⭐ 503 | 🐛 45 | 🌐 C | 📅 2026-08-14 - FC Firmware focusing on flight performance, innovative filtering, leading-edge feature additions, and wide target support.
...
* [MAVLink](https://github.com/mavlink/mavlink) ⭐ 2,393 | 🐛 140 | 🌐 Python | 📅 2026-08-13 - Micro Air Vehicle Message Marshalling Library.
...
* [QGroundControl](https://github.com/mavlink/qgroundcontrol) ⭐ 4,843 | 🐛 987 | 🌐 C++ | 📅 2026-08-13 - Cross-platform ground control station for drones (Android, iOS, Mac OS, Linux, Windows).
...
* [JPL Open Source Rover](https://github.com/nasa-jpl/open-source-rover) ⭐ 9,576 | 🐛 18 | 🌐 Prolog | 📅 2026-08-13 - Nasa JPL scaled down version of the curiosity rover, made of COTS.
